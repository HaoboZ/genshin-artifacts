...
export const builds: Record<CharacterKey, Build | Build[]> = {
	...
	Chiori: {
		...
		weapon: [
			'UrakuMisugiri',
			['LightbearingMoonshard', 'PrimordialJadeCutter', 'PeakPatrolSong'],
			[
				'HarbingerOfDawn',
				'CinnabarSpindle',
				'LightOfFoliarIncision',
	...
	Columbina: [
		{
			key: 'Columbina',
			role: 'High Energy Requirement Off-Field DPS & Buff Support',
	...
	Dori: {
		...
		mainStat: {
			...
			goblet: ['hp_', 'eleMas'],
			circlet: ['heal_', 'hp_', 'eleMas', 'critRate_'],
		},
	...
	Escoffier: {
		key: 'Escoffier',
		role: 'High Energy Requirement Off-Field DPS',
		weapon: [
			'SymphonistOfScents',
			'EngulfingLightning',
			'CalamityQueller',
	...
	Freminet: {
		...
		role: 'Physical DPS',
		weapon: [
			['SkywardPride', 'FangOfTheMountainKing', 'AThousandBlazingSuns'],
		...
		group: 1,
		artifact: ['PaleFlame', 'GoldenTroupe', 'GladiatorsFinale', 'MarechausseeHunter'],
		mainStat: { sands: 'atk_', goblet: 'physical_dmg_', circlet: 'critRD_' },
		subStat: ['enerRech_', 'critRD_', 'atk_', 'eleMas'],
	},
	Furina: {
	...
	Gorou: {
		...
		artifact: [
			'TheExile',
			['NoblesseOblige', 'ScrollOfTheHeroOfCinderCity'],
			['Instructor', 'SilkenMoonsSerenade'],
		],
		mainStat: {
			sands: 'enerRech_',
	...
	Ifa: {
		...
		weapon: [
			...
			['FlowingPurity', 'SunnyMorningSleepIn', 'MappaMare', 'TheWidsith', 'MemoryOfDust'],
		],
		group: 0,
		artifact: ['ObsidianCodex', 'ViridescentVenerer', 'ScrollOfTheHeroOfCinderCity'],
	...
	Ineffa: {
		key: 'Ineffa',
		role: 'Off-Field DPS & Buff & Shield Support',
		weapon: [
			'FracturedHalo',
			'StaffOfTheScarletSands',
	...
	Jahoda: {
		key: 'Jahoda',
		role: 'Off-Field Reaction DPS & Heal Support',
	...
	KamisatoAyato: [
		{
			...
			weapon: [
				...
				'MistsplitterReforged',
				'LightOfFoliarIncision',
				['SkywardBlade', 'SplendorOfTranquilWaters', 'LightbearingMoonshard'],
				'SummitShaper',
				['FinaleOfTheDeep', 'TheBlackSword', 'KagotsurubeIsshin'],
				'LionsRoar',
	...
	Kaveh: {
		...
		weapon: [
			['FlameForgedInsight', 'FavoniusGreatsword'],
			'SacrificialGreatsword',
			'MailedFlower',
	...
	Keqing: {
		...
		role: 'Aggravate DPS',
		weapon: [
			['MistsplitterReforged', 'PrimordialJadeCutter', 'HaranGeppakuFutsu'],
			['LightOfFoliarIncision', 'UrakuMisugiri'],
			['HarbingerOfDawn', 'SplendorOfTranquilWaters', 'LightbearingMoonshard', 'Absolution'],
			['FreedomSworn', 'WolfFang'],
			['TheBlackSword', 'ToukabouShigure', 'CalamityOfEshu'],
			['IronSting', 'FinaleOfTheDeep', 'SummitShaper', 'LionsRoar'],
		],
		group: 0,
	...
	Klee: {
		...
		weapon: [
			'ReliquaryOfTruth',
			['LostPrayerToTheSacredWinds', 'KagurasVerity', 'VividNotions'],
			['TomeOfTheEternalFlow', 'CashflowSupervision'],
			['TulaytullahsRemembrance', 'SurfsUp'],
			'SkywardAtlas',
			['TheWidsith', 'SolarPearl'],
			'SacrificialJade',
			'FlowingPurity',
		],
		group: 0,
		artifact: [
			['Lavawalker', 'ADayCarvedFromRisingWinds'],
			['EchoesOfAnOffering', 'DesertPavilionChronicle'],
			'WanderersTroupe',
			'FragmentOfHarmonicWhimsy',
		],
	...
	Lauma: {
		key: 'Lauma',
		role: 'Buff Support (High-Energy Requirement)',
		weapon: [
	...
	Linnea: {
		key: 'Linnea',
		role: 'Off-Field DPS & Buff and Heal Support',
		weapon: [
	...
	Nicole: {
		...
		weapon: [
			'AngelosHeptades',
			'MemoryOfDust',
			['CranesEchoingCall', 'SkywardAtlas', 'StarcallersWatch'],
			'OathswornEye',
			['HakushinRing', 'FlowingPurity'],
			'FavoniusCodex',
			'ThrillingTalesOfDragonSlayers',
		],
		group: 0,
		artifact: ['CelestialGift', ['ScrollOfTheHeroOfCinderCity', 'NoblesseOblige']],
		mainStat: { sands: ['enerRech_', 'atk_'], goblet: 'atk_', circlet: ['atk_', 'critRate_'] },
		subStat: ['enerRech_', 'atk_', 'critRate_'],
	},
	Nilou: {
		key: 'Nilou',
	...
	Prune: {
		...
		weapon: [
			'FavoniusCodex',
			['AngelosHeptades', 'CranesEchoingCall'],
		...
		group: 2,
		artifact: [['ViridescentVenerer', 'CelestialGift'], 'NoblesseOblige'],
		mainStat: {
			sands: ['enerRech_', 'atk_'],
			goblet: 'atk_',
			circlet: ['atk_', 'critRate_'],
	...
	Razor: {
		...
		weapon: [
			...
			'EarthShaker',
			['PrototypeArchaic', 'UltimateOverlordsMegaMagicSword'],
		],
		group: 1,
		artifact: [
			'ADayCarvedFromRisingWinds',
	...
	Sucrose: {
		key: 'Sucrose',
		role: 'Elemental Mastery Support',
		weapon: [
			['AThousandFloatingDreams', 'SunnyMorningSleepIn'],
			'WanderingEvenstar',
	...
	Traveler: {
		...
		artifact: [
			'ScrollOfTheHeroOfCinderCity',
			['TenacityOfTheMillelith', 'NoblesseOblige', 'Instructor'],
		],
		mainStat: { sands: ['enerRech_', 'atk_'], goblet: 'pyro_dmg_', circlet: 'critRD_' },
	...
	Venti: [
		...
		},
		{
			...
			weapon: [
				...
				['AmosBow', 'Slingshot', 'SongOfStillness', 'TheViridescentHunt'],
				['Rust', 'MouunsMoon'],
			],
			group: 0,
			artifact: [
	...
	Wanderer: {
		key: 'Wanderer',
		role: 'DPS (With External ATK Buffs)',
		weapon: [
			'TulaytullahsRemembrance',
			'LostPrayerToTheSacredWinds',
			'TheWidsith',
	...
	Xianyun: {
		key: 'Xianyun',
		role: 'Low Energy Requireemnt Buff & Heal Support',
		weapon: [
			'CranesEchoingCall',
			['SkywardAtlas', 'MemoryOfDust'],
			'CashflowSupervision',
	...
	Xingqiu: {
		key: 'Xingqiu',
		role: 'Low Energy Requirement (Off-Field DPS)',
		weapon: [
			...
			['SplendorOfTranquilWaters', 'LightbearingMoonshard'],
			'WolfFang',
			'FavoniusSword',
		...
		artifact: [
			'EmblemOfSeveredFate',
			['NoblesseOblige', 'ScrollOfTheHeroOfCinderCity'],
			['NymphsDream', 'ADayCarvedFromRisingWinds'],
			'BlizzardStrayer',
		],
