...
export const builds: Record<CharacterKey, Build> = {
	...
	Mavuika: {
		...
		weapon: [
			...
			['TheUnforged', 'RedhornStonethresher', 'WolfsGravestone'],
			'SerpentSpine',
			'MailedFlower',
			'TidalShadow',
			'Rainslasher',
		...
		group: 0,
		artifact: ['ObsidianCodex', 'ScrollOfTheHeroOfCinderCity', 'MarechausseeHunter'],
		mainStat: { sands: ['eleMas', 'atk_'], goblet: 'pyro_dmg_', circlet: 'critRD_' },
	...
	Ineffa: {
		...
		weapon: [
			...
			'EngulfingLightning',
			['KitainCrossSpear', 'SkywardSpine', 'PrimordialJadeWingedSpear'],
			'BalladOfTheFjords',
			'Deathmatch',
		],
		group: 0,
		artifact: [
			'GildedDreams',
			'ThunderingFury',
			['EmblemOfSeveredFate', 'GoldenTroupe'],
			'TenacityOfTheMillelith',
		],
		mainStat: {
			sands: ['atk_', 'enerRech_'],
	...
	Xingqiu: {
		...
		weapon: [
			...
			['SummitShaper', 'SkywardBlade'],
			'SplendorOfTranquilWaters',
			'WolfFang',
			'FavoniusSword',
			['FleuveCendreFerryman', 'FinaleOfTheDeep', 'AmenomaKageuchi', 'HarbingerOfDawn'],
			'FreedomSworn',
		],
		group: 0,
		artifact: [
