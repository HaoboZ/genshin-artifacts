...
import type { CharacterKey } from '@/src/good';

export const tier: Record<CharacterKey, Tier> = {
	Traveler: {
		key: 'Traveler',
		role: 'DPS',
		...
		subStat: [['critRate_', 'critDMG_'], 'atk_', 'enerRech_', 'eleMas', 'atk'],
	},
	// Pyro
	Amber: {
		key: 'Amber',
		...
		subStat: ['enerRech_', ['critRate_', 'critDMG_'], 'atk_', 'eleMas', 'atk'],
	},
	Xiangling: {
		key: 'Xiangling',
		role: 'Off-Field DPS',
	...
	Bennett: {
		...
		subStat: [['critRate_', 'critDMG_'], 'atk_', 'enerRech_', 'eleMas'],
	},
	Xinyan: {
		key: 'Xinyan',
		role: 'Physical DPS',
		...
		subStat: [['critRate_', 'critDMG_'], 'atk_', 'enerRech_', 'def_'],
	},
	Yanfei: {
		key: 'Yanfei',
		role: 'DPS',
	...
	Diluc: {
		...
		subStat: [['critRate_', 'critDMG_'], 'atk_', 'eleMas', 'enerRech_'],
	},
	Klee: {
		key: 'Klee',
		role: 'DPS',
		...
		artifact: ['Lavawalker', 'CrimsonWitchOfFlames'],
		mainStat: {
			sands: 'atk_',
			goblet: 'pyro_dmg_',
			circlet: ['critRate_', 'critDMG_'],
		},
		subStat: [['critRate_', 'critDMG_'], 'atk_', 'eleMas', 'enerRech_', 'atk'],
	},
	HuTao: {
		key: 'HuTao',
		role: 'DPS',
		...
		subStat: [['critRate_', 'critDMG_'], 'eleMas', 'hp_', 'atk_', 'enerRech_'],
	},
	Yoimiya: {
		key: 'Yoimiya',
		role: 'DPS',
	...
	Lyney: {
		...
		subStat: [['critRate_', 'critDMG_'], 'atk_', 'enerRech_', 'atk'],
	},
	// Dendro
	Collei: {
		key: 'Collei',
		...
		subStat: ['enerRech_', ['critRate_', 'critDMG_'], ['atk_', 'eleMas']],
	},
	Yaoyao: {
		key: 'Yaoyao',
		role: 'Support',
	...
	Tighnari: {
		...
		weapon: [
			...
			'AmosBow',
			['Slingshot', 'TheViridescentHunt', 'WindblumeOde'],
			[
				'FadingTwilight',
				'PrototypeCrescent',
				'IbisPiercer',
		...
		subStat: [['critRate_', 'critDMG_'], 'eleMas', 'atk_', 'enerRech_'],
	},
	Nahida: {
		key: 'Nahida',
		role: 'DPS & Support',
		...
		subStat: ['enerRech_', ['critRate_', 'critDMG_', 'eleMas'], 'atk_'],
	},
	Alhaitham: {
		key: 'Alhaitham',
		role: 'Spread DPS',
		...
		subStat: ['enerRech_', ['critRate_', 'critDMG_'], 'eleMas', 'atk_', 'atk'],
	},
	Baizhu: {
		key: 'Baizhu',
		role: 'Support',
	...
	Barbara: {
		...
		artifact: ['OceanHuedClam', 'MaidenBeloved', 'Instructor'],
	...
	Candace: {
		...
		mainStat: {
			...
			circlet: ['hp_', 'critRate_', 'critDMG_'],
		},
	...
	SangonomiyaKokomi: {
		...
		artifact: ['TenacityOfTheMillelith', 'OceanHuedClam', 'MaidenBeloved'],
		mainStat: {
			sands: ['enerRech_', 'hp_'],
			goblet: 'hp_',
			circlet: ['heal_', 'hp_'],
	...
	KamisatoAyato: {
		...
		subStat: [['critRate_', 'critDMG_'], 'atk_', 'enerRech_', 'hp_', 'eleMas', 'atk'],
	},
	Yelan: {
		key: 'Yelan',
		role: 'Off-Field DPS',
		...
		subStat: ['enerRech_', ['hp_', 'critRate_', 'critDMG_'], 'hp'],
	},
	Nilou: {
		key: 'Nilou',
		role: 'Bloom Support',
		...
		mainStat: { sands: ['hp_', 'enerRech_'], goblet: 'hp_', circlet: 'hp_' },
		subStat: ['hp_', 'hp', 'enerRech_', 'eleMas', ['critRate_', 'critDMG_']],
	},
	Neuvillette: {
		key: 'Neuvillette',
		role: 'DPS',
		...
		subStat: ['enerRech_', ['critRate_', 'critDMG_', 'hp_'], 'hp'],
	},
	// Electro
	Fischl: {
		key: 'Fischl',
	...
	Keqing: {
		...
		subStat: [['critRate_', 'critDMG_'], ['atk_', 'eleMas'], 'atk', 'enerRech_'],
	},
	RaidenShogun: {
		key: 'RaidenShogun',
		role: 'DPS',
	...
	YaeMiko: {
		...
		subStat: [['critRate_', 'critDMG_'], 'eleMas', 'atk_', 'enerRech_', 'atk'],
	},
	Cyno: {
		key: 'Cyno',
		role: 'Quickbloom DPS',
		...
		subStat: ['enerRech_', 'eleMas', ['critRate_', 'critDMG_'], 'atk_'],
	},
	// Cryo
	Diona: {
		key: 'Diona',
	...
	Layla: {
		...
		subStat: ['hp_', 'enerRech_', ['critRate_', 'critDMG_']],
	},
	Mika: {
		key: 'Mika',
		role: 'Support',
	...
	Ganyu: {
		...
		subStat: [['critRate_', 'critDMG_'], 'eleMas', 'atk_', 'atk'],
	},
	Eula: {
		key: 'Eula',
		role: 'DPS',
		...
		subStat: [['critRate_', 'critDMG_'], 'enerRech_', 'atk_', 'atk'],
	},
	KamisatoAyaka: {
		key: 'KamisatoAyaka',
		role: 'DPS',
	...
	Shenhe: {
		...
		subStat: ['enerRech_', 'atk_', ['critRate_', 'critDMG_'], 'atk'],
	},
	// Anemo
	Sucrose: {
		key: 'Sucrose',
		...
		subStat: ['eleMas', 'enerRech_', 'atk_', ['critRate_', 'critDMG_']],
	},
	Sayu: {
		key: 'Sayu',
		role: 'Support',
	...
	Venti: {
		...
		subStat: ['eleMas', 'enerRech_', 'atk_', ['critRate_', 'critDMG_'], 'atk'],
	},
	Xiao: {
		key: 'Xiao',
		role: 'DPS',
	...
	Wanderer: {
		...
		subStat: [['critRate_', 'critDMG_'], 'atk_', 'atk', 'eleMas', 'enerRech_'],
	},
	// Geo
	Ningguang: {
		key: 'Ningguang',
	...
	Noelle: {
		...
		artifact: ['HuskOfOpulentDreams', 'RetracingBolide', 'GladiatorsFinale'],
		mainStat: {
			sands: ['def_', 'atk_'],
			goblet: 'geo_dmg_',
			circlet: ['critRate_', 'critDMG_'],
		},
		subStat: [['critRate_', 'critDMG_'], 'enerRech_', 'def_'],
	},
	Gorou: {
		key: 'Gorou',
		role: 'Support',
	...
	Albedo: {
		...
		mainStat: {
			sands: 'def_',
			goblet: 'geo_dmg_',
			circlet: ['critRate_', 'critDMG_', 'def_'],
		},
		subStat: [['critRate_', 'critDMG_'], 'def_', 'atk_', 'enerRech_'],
	},
	AratakiItto: {
		key: 'AratakiItto',
		role: 'DPS',
		...
		subStat: [['critRate_', 'critDMG_'], 'def_', 'enerRech_', 'atk_', 'def', 'atk'],
	},
};
